...
function file_get_html() {
	...
	$args = func_get_args();
	$dom->load(call_user_func_array('teste', $args), true);
	return $dom;
}

function teste($site, $argumentos){
	...
	if(!$fp) {
		...
		$query_url = $argumentos;

		if(strpos($argumentos, "?") != false){
			$query_url.= "&formato=query_string";
		}
